...
## Cloned from: https://raw.githubusercontent.com/FenyoLab/L1EM/master/run_L1EM.sh
...
# L1EM_bed=$L1EM_directory'/annotation/L1EM.400.bed' # commented out this line
# L1EM_fa=$L1EM_directory'/annotation/L1EM.400.fa'   # commented out this line
